        ...
        <form >
          <ul className="form-container">
            ...
            <li>
              ...
              <img className="avatar-image" src={this.state.API_IMG + "avatars/"+ currentUser.avatar} alt={currentUser.avatar}></img>
            ...
            <li className="form-group">
                ...
                <img className="avatar-image" src={this.state.API_IMG + "avatars/" + this.state.avatar} alt={this.state.avatar}></img>
